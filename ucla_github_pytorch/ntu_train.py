...
data_path_train = root_path + 'train_data_joint.npy'
data_path_train_label = root_path + 'train_label.pkl'

dataset_train = NTUDataset(data_path_train,data_path_train_label)

data_path_test = root_path + 'val_data_joint.npy'
data_path_test_label = root_path + 'val_label.pkl'

dataset_test = NTUDataset(data_path_test,data_path_test_label)
